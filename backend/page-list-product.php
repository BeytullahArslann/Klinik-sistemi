          ...
          <div class="modal-content">
            <div class="modal-body">
              <div class="popup text-left">
                <h4 class="mb-3">Ürün Düzenleme</h4>
                <form id="productForm" method="post" data-toggle="validator">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label id="productId" value="" ></label>
            ...
            <div class="table-responsive col-lg-12">
              ...
              >
                <div class="row">
                  ...
                  $productBarcodeNo = $sorgu["productBarcodeNo"];
                  $productName = $sorgu["productName"];
                  $productBuyPrice = $sorgu["productBuyPrice"];
                  $productSellPrice = $sorgu["productSellPrice"];
                  $productStock = $sorgu["productStock"];
                  $productLastDate = $sorgu["productLastDate"];
                  echo "<tr id='$productId' class='odd'><td>$productBarcodeNo</td><td>".utf8_encode($productName)."</td>"."<td>".$productBuyPrice."</td>"."<td>".$productSellPrice."</td>"."<td>".$productStock."</td>"."<td>".$productLastDate."</td>";
                  echo "<td><div class='d-flex align-items-center list-action'><button type='button' data-toggle='modal' data-target='#new-order' 
                  onclick='popupFiller($productId,$productBarcodeNo,`$productName`,$productBuyPrice,$productSellPrice,$productStock,`$productLastDate`)' class='btn btn-primary mr-2 btn-info' title='Düzenle'>✎</button>
                              <button
                                type='button'
            ...
            ?>
                      ...
                      <tfoot>
                        <tr>
                          ...
                          <th rowspan="1" colspan="1">Alış Fiyatı</th>
                          <th rowspan="1" colspan="1">Satış Fiyatı</th>
                          <th rowspan="1" colspan="1">Stok</th>
                          <th rowspan="1" colspan="1">S.K.T</th>
                ...
                <div class="row"><div class="col-sm-12 col-md-5"></div></div>
              </div>
            </div>
          </div>
          <!-- Page end  -->
...
var productBarcodeNo = $("#productBarcodeNo").val();
...
function popupFiller(productId,productBarcodeNo,productName,productBuyPrice,productSellPrice,productStock,productDate){
$("#productId").val(productId);
$("#productName").val(productName);
$("#productBarcodeNo").val(productBarcodeNo);
$("#productDate").val(productDate);
$("#productStock").val(productStock);
$("#productPriceBuy").val(productBuyPrice);
$("#productPriceSell").val(productSellPrice);
}
