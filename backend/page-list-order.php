              ...
              >
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    $sorgu = $conn->query("SELECT orderId,orderProductId,productName,customerName,orderDate,orderPrice,orderStatus,orderQuantity FROM TblOrder left join tblproduct on orderProductId = productId left join tblcustomer on orderCustomerId = customerId ");
                  ...
                  onclick='completeOrder($orderId,1,$orderPrice)' class='btn btn-primary mr-2 btn-success' title='Tamamla'>✓</button>";
                       echo "<button type='button' id='buttonx$orderId'
                  onclick='completeOrder($orderId,0,$orderPrice)' class='btn btn-primary mr-2 btn-danger' title='Geri Al' style='display:none'>X</button>"; 
                      }else{
                        echo "<button type='button' id='button$orderId'
                  onclick='completeOrder($orderId,1,$orderPrice)' class='btn btn-primary mr-2 btn-success' title='Tamamla' style='display:none'>✓</button>";
                        echo "<button type='button' id='buttonx$orderId'
                  onclick='completeOrder($orderId,0,$orderPrice)' class='btn btn-primary mr-2 btn-danger' title='Geri Al'>X</button>";
                      }
...
if(orderStatus == 1){
  $('#button'+orderId).hide();
  $('#buttonx'+orderId).show();
}else{
  $('#button'+orderId).show();
  $('#buttonx'+orderId).hide();
}
